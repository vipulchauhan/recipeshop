package in.rs.repository;

import in.rs.RecipeShopApp;
import in.rs.config.Constants;
import in.rs.config.audit.AuditEventConverter;
import in.rs.domain.PersistentAuditEvent;
...
import static in.rs.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
