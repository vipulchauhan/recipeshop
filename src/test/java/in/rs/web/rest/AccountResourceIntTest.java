package in.rs.web.rest;

import in.rs.RecipeShopApp;
import in.rs.config.Constants;
import in.rs.domain.Authority;
import in.rs.domain.User;
import in.rs.repository.AuthorityRepository;
import in.rs.repository.UserRepository;
import in.rs.security.AuthoritiesConstants;
import in.rs.service.MailService;
import in.rs.service.UserService;
import in.rs.service.dto.PasswordChangeDTO;
import in.rs.service.dto.UserDTO;
import in.rs.web.rest.errors.ExceptionTranslator;
import in.rs.web.rest.vm.KeyAndPasswordVM;
import in.rs.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = RecipeShopApp.class)
